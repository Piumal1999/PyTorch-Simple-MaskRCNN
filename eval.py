...
def main(args):
    ...
    d_test = pmr.datasets(args.dataset, args.data_dir, "test2017", train=True) # VOC 2012. set train=True for eval
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir", default="data_0718")
    parser.add_argument("--ckpt-path", default="maskrcnn_coco-88.pth")
